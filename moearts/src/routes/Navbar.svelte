<script>
  import Logo from "$lib/images/svg/Logo_NB.svg";
...
<nav class="menu-box">
  <div class="menu">
    <a class="logo" href="/"
      ><div class="logo">
        <img class="moe" src={Logo} alt="logo" width="24px" />GaiaMoe
      </div></a
    >
    <div class="links">
...
<style>
  ...
  .sidebar {
    position: fixed;
    top: 0;
    right: -150%; /* Nasconde il menu fuori dallo schermo */
    width: 100%;
    height: 100vh;
    background: #1B1B1B;
